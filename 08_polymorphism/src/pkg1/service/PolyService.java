...
public class PolyService {
	...
	public void printObject(Object obj) {
		...
		if(obj instanceof Child) {
			...
			// 김 / 50000 / 소나타
			// obj가 참조하고 있는 객체가 Child여도
			// obj가 Object 타입이기 때문에 Child객체 안의 Object만 참조 할 수 있음
			// -> 다운 캐스팅 해야함
			Child c = (Child)obj; // Child로 다운 캐스팅
			System.out.printf("%s / %d / %s\n", c.getLastName(), c.getMoney(), c.getCar());
		}
	 ...
	 */
	public void test2() {
		Object o1 = getInstance(1); // Object, Ox100
		
		// 부모 참조변수 = 자식 객체 -> 업 캐스팅 적용
		Object o2 = getInstance(2); // Parent, Ox200
		Object o3 = getInstance(3); // Child, Ox300
		
		// Parent p = getInstance(2);
		// Type mismatch: cannot convert from Object to Parent
