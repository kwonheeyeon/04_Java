...
public class TryCatchService {
	 ...
	 * - catch(예외 참조 변수) {}
	 *          :try에서 던져진 예외를
	 *           ()에 작성된 참조 변수로 잡아서 처리하는 구문
	 */
	public void test2() {
		// InputMismatchException이 던져질 가능성이 있는 코드
		try {
	...
	public void test5() {
		...
		try {
			...
			System.out.println("int 정수만 입력해주세요");
		}catch(ArithmeticException e){
