...
public class StaticTestRun {
	public static void main(String[] args) {
		...
		k1.setName("김철수");
		k1.setId("000719-1234567");
		
		Korean k2 = new Korean();
		
		k2.setName("박영희");
		k2.setId("000618-2345678");
		...
		System.out.printf("k2 : %d / %s / %s \n", k1.nationalCode, k2.getName(), k2.getId());
		...
		// 왜 k1.nationCode / k2.nationalCode에 노란줄이 떠있을까??
		...
		System.out.println("Korean.nationalCode : " + Korean.nationalCode);
		System.out.println("K1.nationalCode : " + k1.nationalCode);
		System.out.println("K2.nationalCode : " + k2.nationalCode);
